...
class UnitConverterScreenState extends State<UnitConverterScreen> {
  ...
  String _selectedBaseUnit = 'Meter';
  String _selectedTargetUnit = 'Kilometer';
  double _convertedAmount = 0.0;

  final Map<String, double> _unitRates = {
    'Meter': 1.0,
    'Centimeter': 100.0,
    'Kilometer': 0.001,
    'Mile': 0.000621371,
  ...
  void updateConvertedAmount() {
    ...
    if (amount != null) {
      final conversionRateBase = _unitRates[_selectedBaseUnit] ?? 1.0;
      final conversionRateTarget = _unitRates[_selectedTargetUnit] ?? 1.0;
              ...
              children: [
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    items: _unitRates.keys.map((currency) {
